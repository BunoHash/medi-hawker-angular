...
import { MenuService } from './pages/app.menu/app.menu.service';
import { AppComponent } from './startup/app.component/app.component';
...
export const jwtConfig = {
    ...
    whiteListedDomains: ['http://localhost:58908']
};
...
export class AppModule {
    ...
    constructor() {
        console.log("App moudle is initiated");
        //console.log("token: "+jwtConfig.tokenGetter);
